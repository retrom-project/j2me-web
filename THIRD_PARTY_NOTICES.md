...
- [retrom-project/miniJVM](https://github.com/retrom-project/miniJVM)，固定到 `cf0f91fcc42b580f35c8cde8d2baef11bd44013b`（浏览器生命周期与多维数组修复），基于 `digitalgust/miniJVM@ac94e62781deda037875ff69d78f272a327a72bc`。其顶层 LICENSE 声明 `/minijvm/java/` 为 GPL-2.0，其余部分为 MIT License；分发时不能把整个仓库笼统视为 MIT。
